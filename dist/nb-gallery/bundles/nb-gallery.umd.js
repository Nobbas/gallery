(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/platform-browser'), require('@angular/core'), require('@fortawesome/angular-fontawesome')) :
    typeof define === 'function' && define.amd ? define('nb-gallery', ['exports', '@angular/common', '@angular/platform-browser', '@angular/core', '@fortawesome/angular-fontawesome'], factory) :
    (factory((global['nb-gallery'] = {}),global.ng.common,global.ng.platformBrowser,global.ng.core,global.angularFontawesome));
}(this, (function (exports,common,platformBrowser,core,angularFontawesome) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NbGalleryHelperService = /** @class */ (function () {
        ...
        /** @nocollapse */
        NbGalleryHelperService.ctorParameters = function () {
            return [
                { type: core.Renderer }
            ];
        };
    ...
    var NbGalleryItemComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        NbGalleryItemComponent.ctorParameters = function () {
            return [
    ...
    var NbGalleryIframeComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        NbGalleryIframeComponent.ctorParameters = function () {
            return [
                { type: platformBrowser.DomSanitizer }
            ];
        };
        NbGalleryIframeComponent.propDecorators = {
            src: [{ type: core.Input }],
            pauseVideo: [{ type: core.Input, args: ['pause',] }],
    ...
    var NbGalleryThumbnailsComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        NbGalleryThumbnailsComponent.ctorParameters = function () {
            return [
                { type: platformBrowser.DomSanitizer },
                { type: core.ElementRef },
                { type: NbGalleryHelperService }
    ...
    var NbGalleryPreviewComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        NbGalleryPreviewComponent.ctorParameters = function () {
            return [
                { type: platformBrowser.DomSanitizer },
                { type: core.ElementRef },
                { type: NbGalleryHelperService },
    ...
    var NbGalleryComponent = /** @class */ (function () {
        function NbGalleryComponent(myElement) {
            ...
            this.itemsReady = new core.EventEmitter();
         ...
         */
            function () {
                var _this = this;
                this.thumbnails = this.items.map(function (item, i) {
                    return new NbGalleryThumbnail({
                        type: item.type,
                        source: item.source,
                        url: item.type === 'image' ? item.small : _this.currentOptions.defaultVideoThumbnnailUrl
                    });
                });
                this.galleryItems = this.items.map(function (item, i) {
                    return new NbGalleryOrderedItem({
                        type: item.type,
                        source: item.source,
                ...
                this.previewItems = this.items.map(function (item, i) {
                    return new NbGalleryOrderedItem({
                        type: item.type,
                        source: item.source,
        ...
        /** @nocollapse */
        NbGalleryComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
        NbGalleryComponent.propDecorators = {
            ...
            items: [{ type: core.Input }],
            itemsReady: [{ type: core.Output }],
            change: [{ type: core.Output }],
            previewOpen: [{ type: core.Output }],
            previewClose: [{ type: core.Output }],
            previewChange: [{ type: core.Output }],
            preview: [{ type: core.ViewChild, args: [NbGalleryPreviewComponent,] }],
            item: [{ type: core.ViewChild, args: [NbGalleryItemComponent,] }],
            thumbnail: [{ type: core.ViewChild, args: [NbGalleryThumbnailsComponent,] }],
    ...
    exports.NbGalleryModule = NbGalleryModule;
    exports.NbGalleryComponent = NbGalleryComponent;
    exports.NbGalleryActionComponent = NbGalleryActionComponent;
    exports.NbGalleryItemComponent = NbGalleryItemComponent;
    exports.NbGalleryVideoComponent = NbGalleryVideoComponent;
    exports.NbGalleryIframeComponent = NbGalleryIframeComponent;
    exports.NbGalleryTagComponent = NbGalleryTagComponent;
    exports.NbGalleryThumbnailsComponent = NbGalleryThumbnailsComponent;
    exports.NbGalleryPreviewComponent = NbGalleryPreviewComponent;
    exports.NbGalleryArrowsComponent = NbGalleryArrowsComponent;
    exports.NbGalleryBulletsComponent = NbGalleryBulletsComponent;
    exports.NbGalleryOptions = NbGalleryOptions;
    exports.NbGalleryItem = NbGalleryItem;
    exports.NbGalleryAnimation = NbGalleryAnimation;
    exports.NbGalleryHelperService = NbGalleryHelperService;
    exports.NbGalleryImageSize = NbGalleryImageSize;
    exports.NbGalleryLayout = NbGalleryLayout;
    exports.NbGalleryOrder = NbGalleryOrder;
    exports.NbGalleryOrderedImage = NbGalleryOrderedImage;
    exports.NbGalleryAction = NbGalleryAction;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=nb-gallery.umd.js.map