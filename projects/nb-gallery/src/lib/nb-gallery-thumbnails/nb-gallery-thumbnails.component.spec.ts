...
describe('NbGalleryThumbnailsComponent', () => {
    let fixture: ComponentFixture<NbGalleryThumbnailsComponent>;
    let comp: NbGalleryThumbnailsComponent;
    let el, thumbnails;

    beforeEach(() => {
        TestBed.configureTestingModule({
          declarations: [ NbGalleryThumbnailsComponent, NbGalleryArrowsComponent, NbGalleryActionComponent ],
          providers: [ NbGalleryHelperService, Renderer ]
        })
        .overrideComponent(NbGalleryThumbnailsComponent, {
            set: {
                styleUrls: [],
            }
        })

        fixture = TestBed.createComponent(NbGalleryThumbnailsComponent);
        ...
        thumbnails = el.querySelector('.nb-gallery-thumbnails');
    });
    ...
    it('should emit event onActiveChange after click on image', (done) => {
        ...
        fixture.detectChanges();
        el.querySelectorAll('.nb-gallery-thumbnail')[1].click();
    });
